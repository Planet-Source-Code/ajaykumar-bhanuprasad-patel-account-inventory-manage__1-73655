...
Begin VB.Form vchr_sales 
   ...
   End
End
Attribute VB_Name = "vchr_sales"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Public rs_vchr_sales_print As New ADODB.Recordset
Public pervious_grid_stk_dtl_col
Public pervious_grid_stk_dtl_row
...
For available_tran_no = 1 To rs_inv_tran_sal.RecordCount
    If rs_inv_tran_sal!stk_invt_trn_vcno = Text5.Text Then ' if the transaction is available
        inventory_transaction_is_available = 0
        rs_inv_tran_sal.Delete
        rs_inv_tran_sal.UpdateBatch
    End If
...
For available_tran_no = 1 To rs_inv_tran_all.RecordCount
    If rs_inv_tran_all!stk_invt_trn_vcno = Text5.Text And rs_inv_tran_all!stk_invt_trn_vchr = "sale" Then ' if the transaction is available
        inventory_transaction_is_available = 0
...
For available_tran_no = 1 To rs_inv_tran_otw.RecordCount
    If rs_inv_tran_otw!stk_invt_trn_vcno = Text5.Text And rs_inv_tran_otw!stk_invt_trn_vchr = "sale" Then ' if the transaction is available
        inventory_transaction_is_available = 0
...
For available_tran_no = 1 To rs_acn_tran_sal.RecordCount
    If rs_acn_tran_sal!fin_acnt_trn_vcno = Text5.Text Then
            rs_acn_tran_sal.Delete
            rs_acn_tran_sal.UpdateBatch
    End If
...
For available_tran_no = 1 To rs_acn_tran_sal.RecordCount
    If rs_acn_tran_sal!fin_acnt_trn_vcno = Text5.Text Then
            rs_acn_tran_sal!fin_acnt_trn_vcno = Text5.Text
            rs_acn_tran_sal!fin_acnt_trn_seno = 1 'transaction_counter
            rs_acn_tran_sal!fin_acnt_trn_vtyp = cmb_vat_type 'Combo0.Text
            rs_acn_tran_sal!fin_acnt_trn_date = DTPicker1.Value
            rs_acn_tran_sal!fin_acnt_trn_time = lbl_time.Caption
            rs_acn_tran_sal!fin_acnt_trn_wday = lbl_day.Caption
            rs_acn_tran_sal!fin_acnt_trn_ldgr = cmb_ledger.Text ' combo_lgr(transaction_counter).Text
            rs_acn_tran_sal!fin_acnt_trn_amnt = lbl_total_amt.Caption ' text_amt(transaction_counter).Text
            rs_acn_tran_sal!fin_acnt_trn_side = "dr"
'            !fin_acnt_trn_nrtn = Text4.Text
            rs_acn_tran_sal!fin_acnt_trn_user = Text6.Text
            rs_acn_tran_sal!fin_acnt_trn_vchr = "sale"
            rs_acn_tran_sal!fin_acnt_trn_slmn = cmb_sales_man.Text
            rs_acn_tran_sal.UpdateBatch
            rs_acn_tran_sal.MoveNext
            rs_acn_tran_sal!fin_acnt_trn_vcno = Text5.Text
            rs_acn_tran_sal!fin_acnt_trn_seno = 2 'transaction_counter
            rs_acn_tran_sal!fin_acnt_trn_vtyp = cmb_vat_type 'Combo0.Text
            rs_acn_tran_sal!fin_acnt_trn_date = DTPicker1.Value
            rs_acn_tran_sal!fin_acnt_trn_time = lbl_time.Caption
            rs_acn_tran_sal!fin_acnt_trn_wday = lbl_day.Caption
            rs_acn_tran_sal!fin_acnt_trn_ldgr = "sales account" ' combo_lgr(transaction_counter).Text"
            rs_acn_tran_sal!fin_acnt_trn_amnt = lbl_total_amt.Caption ' text_amt(transaction_counter).Text
            rs_acn_tran_sal!fin_acnt_trn_side = "cr"
'            !fin_acnt_trn_nrtn = Text4.Text
            rs_acn_tran_sal!fin_acnt_trn_user = Text6.Text
            rs_acn_tran_sal!fin_acnt_trn_vchr = "sale"
            rs_acn_tran_sal!fin_acnt_trn_slmn = cmb_sales_man.Text
...
Next
    If this_entry_is_saved <> 1 Then
        Call open_database
        Call open_rs_acn_tran_sal
            rs_acn_tran_sal.AddNew
            rs_acn_tran_sal!fin_acnt_trn_vcno = Text5.Text
            rs_acn_tran_sal!fin_acnt_trn_seno = 1 'transaction_counter
            rs_acn_tran_sal!fin_acnt_trn_vtyp = cmb_vat_type.Text  'Combo0.Text
            rs_acn_tran_sal!fin_acnt_trn_date = DTPicker1.Value
            rs_acn_tran_sal!fin_acnt_trn_time = lbl_time.Caption
            rs_acn_tran_sal!fin_acnt_trn_wday = lbl_day.Caption
            rs_acn_tran_sal!fin_acnt_trn_ldgr = cmb_ledger.Text ' combo_lgr(transaction_counter).Text
...
If rs_acn_tran_sal.RecordCount > 0 Then
    For iflvn = 1 To rs_acn_tran_sal.RecordCount
    this_voucher_no = rs_acn_tran_sal!fin_acnt_trn_vcno
...
Public Sub set_card_detail()
    ...
    For rs_inv_tran_sal_counter = rs_inv_tran_sal.RecordCount To 1 Step -1
        If List_card.Text = rs_inv_tran_sal!stk_invt_trn_card And cmb_ledger.Text = rs_inv_tran_sal!stk_invt_trn_ldgr Then
        grid_stk_dtl.TextMatrix(grid_stk_dtl.Row, 5) = Format(rs_inv_tran_sal!stk_invt_trn_rate, "0.00")
        End If
...
rs_vchr_sales_print.Open "Select * From inv_tran_sal WHERE stk_invt_trn_vcno = " & Val(Text5.Text) & "", db_co, adOpenDynamic, adLockPessimistic
...
Private Sub grid_stk_dtl_SelChange()
pervious_grid_stk_dtl_col = grid_stk_dtl.Col
pervious_grid_stk_dtl_row = grid_stk_dtl.Row
End Sub
...
'        'MsgBox "You can not click The mouse, Please use keyboard."
'        grid_stk_dtl.Col = 1
'        Exit Sub
End If
End Sub
...
ElseIf keycode_now = 39 Or keycode_now = 13 Then
            ...
            ElseIf grid_stk_dtl.Col = 2 Then    'enter on the starting serial no column
                ...
                'Call open_database
                'Call open_rs_inv_tran_sal
                'rs_inv_tran_sal!stk_invt_trn_splr = ""
                card_is_available = 0
                        'Call open_database
                        'Call open_rs_stk_clsg_srl
                        Call open_rs_tmp_spec_itm_clg_stk
...
Command2.TabIndex = 12
cmd_save_and_exit.TabIndex = 13
cmd_exit.TabIndex = 14
Command1.TabIndex = 15
cmd_delete.TabIndex = 16
cmb_edit.TabIndex = 17
Command3.TabIndex = 18
...
selected_procedure = "Sales Invoice"
...
Call open_database
Call open_rs_acn_tran_sal
For rs_acnt_tran_sal_counter = 1 To rs_acn_tran_sal.RecordCount
If rs_acn_tran_sal!fin_acnt_trn_vcno = selected_voucher_no And rs_acn_tran_sal!fin_acnt_trn_seno = 1 Then
            Text5.Text = rs_acn_tran_sal!fin_acnt_trn_vcno
            'rs_acn_tran_sal!fin_acnt_trn_seno = 1 'transaction_counter
            cmb_vat_type.Text = rs_acn_tran_sal!fin_acnt_trn_vtyp 'Combo0.Text
            DTPicker1.Value = rs_acn_tran_sal!fin_acnt_trn_date
            lbl_time.Caption = rs_acn_tran_sal!fin_acnt_trn_time
            lbl_day.Caption = rs_acn_tran_sal!fin_acnt_trn_wday
            cmb_ledger.Text = rs_acn_tran_sal!fin_acnt_trn_ldgr ' combo_lgr(transaction_counter).Text
            selected_voucher_ledger = cmb_ledger.Text
            lbl_total_amt.Caption = rs_acn_tran_sal!fin_acnt_trn_amnt ' text_amt(transaction_counter).Text
            Text6.Text = rs_acn_tran_sal!fin_acnt_trn_user
...
rs_inv_tran_sal.Open "Select * From [inv_tran_sal] order by stk_invt_trn_id", db_co, adOpenDynamic, adLockPessimistic

For rs_inv_tran_sal_counter = 1 To rs_inv_tran_sal.RecordCount 'inventory_sub_entry_no = 1 To grid_stk_dtl.Rows - 1
If rs_inv_tran_sal!stk_invt_trn_vcno = selected_voucher_no Then
    With rs_inv_tran_sal
        grid_stk_dtl.Rows = grid_stk_dtl.Rows + 1
...
Public Sub set_ledger_grid_zero()
    ...
    grid_lgr_rep.ColWidth(0) = 5
    grid_lgr_rep.ColWidth(1) = 600
    grid_lgr_rep.ColWidth(2) = 600
    grid_lgr_rep.ColWidth(3) = 400
    grid_lgr_rep.ColWidth(4) = 700
    grid_lgr_rep.ColWidth(5) = 900
    grid_lgr_rep.ColWidth(6) = 900
    grid_lgr_rep.ColWidth(7) = 1000
...
Next
    ...
    If ledger_dr_total < ledger_cr_total Then
        ...
        lbl_customer_marq.Caption = selected_voucher_ledger & " Closing Balance is..... Cr. " & Format(ledger_cr_total - ledger_dr_total, "0.00")
        grid_lgr_rep.AddItem ""
        grid_lgr_rep.TextMatrix(b, 4) = "Closing Balance is.....Cr."
        grid_lgr_rep.TextMatrix(b, 5) = Format(ledger_cr_total - ledger_dr_total, "0.00")
        customer_balance_is = Format(ledger_cr_total - ledger_dr_total, "0.00") & "£ dr"
        b = b + 1
        grid_lgr_rep.AddItem ""
        grid_lgr_rep.TextMatrix(b, 5) = "================="
        grid_lgr_rep.TextMatrix(b, 6) = "================="
    ...
    'grid_lgr_rep.TextMatrix(b, 6) = Format(ledger_cr_total, "0.00")
    If ledger_cr_total < ledger_dr_total Then
        lbl_customer_marq.Caption = selected_voucher_ledger & " Closing Balance is..... Dr. " & Format(ledger_dr_total - ledger_cr_total, "0.00")
        grid_lgr_rep.AddItem ""
        grid_lgr_rep.TextMatrix(b, 4) = " Closing Balance is.....Dr. "
        grid_lgr_rep.TextMatrix(b, 6) = Format(ledger_dr_total - ledger_cr_total, "0.00")
        customer_balance_is = Format(ledger_dr_total - ledger_cr_total, "0.00") & "£ cr"
        b = b + 1
        grid_lgr_rep.AddItem ""
        grid_lgr_rep.TextMatrix(b, 5) = "=========="
        grid_lgr_rep.TextMatrix(b, 6) = "=========="
