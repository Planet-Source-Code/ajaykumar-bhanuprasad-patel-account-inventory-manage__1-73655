...
Begin VB.Form vchr_receipt 
   ...
   End
End
Attribute VB_Name = "vchr_receipt"
...
If rs_acn_tran_rct!fin_acnt_trn_vcno = Text1.Text Then
rs_acn_tran_rct.Delete
rs_acn_tran_rct.UpdateBatch
...
If rs_acn_tran_all!fin_acnt_trn_vcno = Text1.Text And rs_acn_tran_all!fin_acnt_trn_vchr = "receipt" Then
...
If rs_acn_tran_all_temp!fin_acnt_trn_vcno = Text1.Text And rs_acn_tran_all_temp!fin_acnt_trn_vchr = "receipt" Then
...
If rs_acn_tran_rct.RecordCount = 0 Then Text1.Text = 1
Text4.Text = ""
...
Call open_rs_acn_tran_rct
Do Until rs_acn_tran_rct.EOF
If rs_acn_tran_rct!fin_acnt_trn_vcno = selected_voucher_no Then
...
If rs_acn_tran_rct.RecordCount > 0 Then
For iflvn = 1 To rs_acn_tran_rct.RecordCount
this_voucher_no = rs_acn_tran_rct!fin_acnt_trn_vcno
...
this_entry_is_saved = 0
Call open_database
Call open_rs_acn_tran_rct 'MsgBox rs_acn_tran_rct.RecordCount
For available_tran_no = 1 To rs_acn_tran_rct.RecordCount
With rs_acn_tran_rct
