...
Do Until rs_acn_tran_cnt.EOF
    If rs_acn_tran_cnt!fin_acnt_trn_vcno = Text1.Text Then
        rs_acn_tran_cnt.Delete
        rs_acn_tran_cnt.UpdateBatch
...
Do Until rs_acn_tran_all.EOF
    If rs_acn_tran_all!fin_acnt_trn_vcno = Text1.Text And rs_acn_tran_all!fin_acnt_trn_vchr = "contra" Then
...
Do Until rs_acn_tran_all_temp.EOF
    If rs_acn_tran_all_temp!fin_acnt_trn_vcno = Text1.Text And rs_acn_tran_all_temp!fin_acnt_trn_vchr = "contra" Then
...
If rs_acn_tran_cnt.RecordCount = 0 Then Text1.Text = 1
Text4.Text = ""
...
If rs_acn_tran_cnt!fin_acnt_trn_vcno = selected_voucher_no Then
...
If rs_acn_tran_cnt.RecordCount > 0 Then
    For iflvn = 1 To rs_acn_tran_cnt.RecordCount
    this_voucher_no = rs_acn_tran_cnt!fin_acnt_trn_vcno
...
For transaction_counter = 1 To sub_entry_no
    ...
    Call open_database
    Call open_rs_acn_tran_cnt
    For available_tran_no = 1 To rs_acn_tran_cnt.RecordCount
...
Call refresh_dr_cr_total_amt
    ...
    If voucher_total_dr_amt < voucher_total_cr_amt Then
            ...
            If LCase(combo_sub_entry_no(index).Text) = LCase("Dr / By") And index >= 1 Then 'And Index = sub_entry_no Then
