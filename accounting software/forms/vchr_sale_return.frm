...
Begin VB.Form vchr_sale_return 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox Text4 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   1
         Text            =   "vchr_sale_return.frx":0000
         Top             =   720
         Width           =   5055
      End
   ...
   End
End
Attribute VB_Name = "vchr_sale_return"
...
For available_tran_no = 1 To rs_inv_tran_srt.RecordCount
    If rs_inv_tran_srt!stk_invt_trn_vcno = Text5.Text Then ' if the transaction is available
        inventory_transaction_is_available = 0
        rs_inv_tran_srt.Delete
        rs_inv_tran_srt.UpdateBatch
    End If
...
For available_tran_no = 1 To rs_inv_tran_all.RecordCount
    If rs_inv_tran_all!stk_invt_trn_vcno = Text5.Text And rs_inv_tran_all!stk_invt_trn_vchr = "sale return" Then ' if the transaction is available
        inventory_transaction_is_available = 0
...
For available_tran_no = 1 To rs_inv_tran_inw.RecordCount
    If rs_inv_tran_inw!stk_invt_trn_vcno = Text5.Text And rs_inv_tran_inw!stk_invt_trn_vchr = "sale return" Then ' if the transaction is available
        inventory_transaction_is_available = 0
...
For available_tran_no = 1 To rs_acn_tran_srt.RecordCount
    If rs_acn_tran_srt!fin_acnt_trn_vcno = Text5.Text Then
            rs_acn_tran_srt.Delete
            rs_acn_tran_srt.UpdateBatch
    End If
...
this_entry_is_saved = 0
    Call open_database
    Call open_rs_acn_tran_srt
If rs_acn_tran_srt.RecordCount > 0 Then
    For available_tran_no = 1 To rs_acn_tran_srt.RecordCount
    If rs_acn_tran_srt!fin_acnt_trn_vcno = Text5.Text Then
            rs_acn_tran_srt!fin_acnt_trn_vcno = Text5.Text
            rs_acn_tran_srt!fin_acnt_trn_seno = 1 'transaction_counter
            rs_acn_tran_srt!fin_acnt_trn_vtyp = cmb_vat_type 'Combo0.Text
            rs_acn_tran_srt!fin_acnt_trn_date = DTPicker1.Value
            rs_acn_tran_srt!fin_acnt_trn_time = lbl_time.Caption
            rs_acn_tran_srt!fin_acnt_trn_wday = lbl_day.Caption
            rs_acn_tran_srt!fin_acnt_trn_ldgr = "sale return account" ' combo_lgr(transaction_counter).Text
            rs_acn_tran_srt!fin_acnt_trn_amnt = lbl_total_amt.Caption ' text_amt(transaction_counter).Text
            rs_acn_tran_srt!fin_acnt_trn_side = "dr"
'            !fin_acnt_trn_nrtn = Text4.Text
            rs_acn_tran_srt!fin_acnt_trn_user = Text6.Text
            rs_acn_tran_srt!fin_acnt_trn_vchr = "sale return"
            'rs_acn_tran_srt!fin_acnt_trn_slmn = cmb_sales_man.Text
            rs_acn_tran_srt.UpdateBatch
            
            rs_acn_tran_srt.MoveNext
            rs_acn_tran_srt!fin_acnt_trn_vcno = Text5.Text
            rs_acn_tran_srt!fin_acnt_trn_seno = 2 'transaction_counter
            rs_acn_tran_srt!fin_acnt_trn_vtyp = cmb_vat_type 'Combo0.Text
            rs_acn_tran_srt!fin_acnt_trn_date = DTPicker1.Value
            rs_acn_tran_srt!fin_acnt_trn_time = lbl_time.Caption
            rs_acn_tran_srt!fin_acnt_trn_wday = lbl_day.Caption
            rs_acn_tran_srt!fin_acnt_trn_ldgr = cmb_ledger.Text ' combo_lgr(transaction_counter).Text"
            rs_acn_tran_srt!fin_acnt_trn_amnt = lbl_total_amt.Caption ' text_amt(transaction_counter).Text
            rs_acn_tran_srt!fin_acnt_trn_side = "cr"
'            !fin_acnt_trn_nrtn = Text4.Text
            rs_acn_tran_srt!fin_acnt_trn_user = Text6.Text
            rs_acn_tran_srt!fin_acnt_trn_vchr = "sale return"
            'rs_acn_tran_srt!fin_acnt_trn_slmn = cmb_sales_man.Text
...
If rs_acn_tran_srt.RecordCount > 0 Then
    For iflvn = 1 To rs_acn_tran_srt.RecordCount
    this_voucher_no = rs_acn_tran_srt!fin_acnt_trn_vcno
...
Public Sub set_card_detail()
    ...
    Call open_database
    Call open_rs_inv_tran_srt
    Dim rs_inv_tran_srt_counter
    If rs_inv_tran_srt.RecordCount > 0 Then rs_inv_tran_srt.MoveLast
    
    For rs_inv_tran_srt_counter = rs_inv_tran_srt.RecordCount To 1 Step -1
        If List_card.Text = rs_inv_tran_srt!stk_invt_trn_card And cmb_ledger.Text = rs_inv_tran_srt!stk_invt_trn_ldgr Then
        grid_stk_dtl.TextMatrix(grid_stk_dtl.Row, 5) = Format(rs_inv_tran_srt!stk_invt_trn_rate, "0.00")
        End If
        rs_inv_tran_srt.MovePrevious
    Next
...
ElseIf keycode_now = 39 Or keycode_now = 13 Then
            ...
            ElseIf grid_stk_dtl.Col = 2 Then    'enter on the starting serial no column
                ...
                'Call open_database
                'Call open_rs_inv_tran_srt
                'rs_inv_tran_srt!stk_invt_trn_splr = ""
                card_is_available = 0
                        'Call open_database
                        'Call open_rs_stk_clsg_srl
                        Call open_rs_tmp_spec_itm_clg_stk
...
selected_procedure = "sale return Invoice"
...
Call open_database
Call open_rs_acn_tran_srt
For rs_acnt_tran_prs_counter = 1 To rs_acn_tran_srt.RecordCount
If rs_acn_tran_srt!fin_acnt_trn_vcno = selected_voucher_no And rs_acn_tran_srt!fin_acnt_trn_seno = 2 Then
            Text5.Text = rs_acn_tran_srt!fin_acnt_trn_vcno
            'rs_acn_tran_srt!fin_acnt_trn_seno = 1 'transaction_counter
            cmb_vat_type.Text = rs_acn_tran_srt!fin_acnt_trn_vtyp 'Combo0.Text
            DTPicker1.Value = rs_acn_tran_srt!fin_acnt_trn_date
            lbl_time.Caption = rs_acn_tran_srt!fin_acnt_trn_time
            lbl_day.Caption = rs_acn_tran_srt!fin_acnt_trn_wday
            cmb_ledger.Text = rs_acn_tran_srt!fin_acnt_trn_ldgr ' combo_lgr(transaction_counter).Text
            selected_voucher_ledger = cmb_ledger.Text
            lbl_total_amt.Caption = rs_acn_tran_srt!fin_acnt_trn_amnt ' text_amt(transaction_counter).Text
            Text6.Text = rs_acn_tran_srt!fin_acnt_trn_user
...
rs_inv_tran_srt.Open "Select * From [inv_tran_srt] order by stk_invt_trn_id", db_co, adOpenDynamic, adLockPessimistic
For rs_inv_tran_srt_counter = 1 To rs_inv_tran_srt.RecordCount 'inventory_sub_entry_no = 1 To grid_stk_dtl.Rows - 1
If rs_inv_tran_srt!stk_invt_trn_vcno = selected_voucher_no Then
    With rs_inv_tran_srt
        grid_stk_dtl.Rows = grid_stk_dtl.Rows + 1
