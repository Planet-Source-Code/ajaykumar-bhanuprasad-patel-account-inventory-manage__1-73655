...
Begin VB.Form da_Gene_cust_repo_main 
   ...
   Begin VB.ComboBox Combo2 
      Height          =   315
      ItemData        =   "da_generate_cust_repo.frx":0000
      Left            =   480
      List            =   "da_generate_cust_repo.frx":0002
      TabIndex        =   7
      Text            =   "Combo2"
      Top             =   -500
      Width           =   3015
...
Public Sub set_grid_report_cust()
        ...
        grid_report_cust.TextMatrix(0, 2) = "Customer Name"
        grid_report_cust.TextMatrix(0, 3) = "card Name"
        grid_report_cust.TextMatrix(0, 4) = "Starting Serial No"
        grid_report_cust.TextMatrix(0, 5) = "Ending serial no"
        grid_report_cust.TextMatrix(0, 6) = "Quantity"
        ...
        grid_report_cust.TextMatrix(0, 11) = "Customer Ref No"
        grid_report_cust.TextMatrix(0, 12) = "response Ref No"
        grid_report_cust.TextMatrix(0, 13) = "Enered by"
        
grid_report_cust.CellAlignment = Center
grid_report_cust.ColWidth(0) = 500
grid_report_cust.ColWidth(1) = 1000
grid_report_cust.ColWidth(2) = 3000
grid_report_cust.ColWidth(3) = 1500
grid_report_cust.ColWidth(4) = 2000
grid_report_cust.ColWidth(5) = 2000
grid_report_cust.ColWidth(6) = 1000
grid_report_cust.ColWidth(7) = 500
grid_report_cust.ColWidth(8) = 800
grid_report_cust.ColWidth(9) = 1700
grid_report_cust.ColWidth(10) = 1400
grid_report_cust.ColWidth(11) = 1700
grid_report_cust.ColWidth(12) = 1700
grid_report_cust.ColWidth(13) = 1500
